...
namespace TrySystem.InventoryDataSetTableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [ItemID] = @ItemID, [ItemName] = @ItemName, [Price] = @Price WHERE (([ItemID] = @Original_ItemID) AND ((@IsNull_ItemName = 1 AND [ItemName] IS NULL) OR ([ItemName] = @Original_ItemName)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)));
SELECT ItemID, ItemName, Price FROM Items WHERE (ItemID = @ItemID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TrySystem.Properties.Settings.Default.InventoryConnectionString;
        }
        ...
        public virtual int Delete(string Original_ItemID, string Original_ItemName, global::System.Nullable<decimal> Original_Price) {
        ...
        public virtual int Insert(string ItemID, string ItemName, global::System.Nullable<decimal> Price) {
            if ((ItemID == null)) {
        ...
        public virtual int Update(string ItemID, string ItemName, global::System.Nullable<decimal> Price, string Original_ItemID, string Original_ItemName, global::System.Nullable<decimal> Original_Price) {
            if ((ItemID == null)) {
                throw new global::System.ArgumentNullException("ItemID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ItemName, global::System.Nullable<decimal> Price, string Original_ItemID, string Original_ItemName, global::System.Nullable<decimal> Original_Price) {
